...
const StoryPortfolio: React.FC<{ projects: Project[] }> = ({ projects }) => {
  ...
  return (
    ...
    >
      <h1 className="text-4xl font-heading font-bold mb-6">Story Portfolio</h1>

      {projects.map((project) => (
        <section key={project.id} className="mb-20 md:mb-32">
          <h2 className="text-2xl md:text-3xl font-heading font-bold mb-3 text-center">{project.title}</h2>
            ...
            <div className="mb-4">
              {('video' in project && project.video) ? (
                <div className="w-full max-w-6xl mx-auto">
                  <div className="overflow-hidden w-full rounded bg-black" style={{ aspectRatio: '16/9', maxHeight: '80vh' }}>
                    <video
                      controls
                  ...
                  {project.instagram && (
                    <div className="mt-3 flex justify-center">
                      <a
                        ...
                        className="inline-block bg-black text-gold px-4 py-2 rounded shadow hover:opacity-90"
                      >
                        Open in Instagram
                      </a>
                    </div>
                ...
                <div className="w-full max-w-6xl mx-auto">
                  <div className="overflow-hidden w-full rounded" style={{ aspectRatio: '16/9', maxHeight: '80vh' }}>
                    {/** Prefer privacy-friendly domain and add referrerPolicy/loading to improve compatibility */}
                    <iframe
                ...
                <audio controls src={project.audio} className="w-full max-w-4xl mx-auto" />
              ) : null}
            </div>
            ...
            <div className="relative w-full rounded-lg shadow-soft flex items-center justify-center">
              {project.slides ? (
                ...
                <div className="relative w-full bg-gray-100 rounded-lg shadow-soft flex items-center justify-center">
                  <p className="text-gray-500">Slide deck / animatic placeholder — UI to be implemented.</p>
                </div>
              )}
            </div>
          </div>
