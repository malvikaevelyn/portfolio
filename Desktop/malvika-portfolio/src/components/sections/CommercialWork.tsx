...
import { Project } from '../../lib/commercialProjects';

const CommercialWork: React.FC<{ projects: Project[] }> = ({ projects }) => {
  ...
  return (
    ...
    >
      <h1 className="text-2xl sm:text-4xl font-heading font-bold mb-4 sm:mb-6">Commercial Work</h1>
