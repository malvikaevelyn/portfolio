  ...
  return (
    ...
    >
      ...
      <div className="text-center relative z-10">
        <h1 className="text-6xl md:text-8xl font-heading font-bold uppercase tracking-wide text-white">
          MALVIKA EVELYN
        </h1>
        ...
        <div className="mt-10">
          <MotionButton
            ...
            className="px-8 py-3 border border-white text-white bg-transparent font-bold rounded-lg hover:bg-white/10 transition duration-200"
            whileTap={{ scale: 0.98 }}
          >
            Explore
          </MotionButton>
