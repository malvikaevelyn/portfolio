...
const About: React.FC = () => {
  return (
    <div className="text-black p-8" style={{ backgroundColor: backgrounds.default.color }}>
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          ...
          <div className="flex items-center gap-4">
            ...
            <motion.div whileHover={{ scale: 1.05 }}>
              <a href="tel:+917760690784" className="text-viridian text-2xl flex items-center gap-2">
                <FaPhone />
                <span className="text-sm text-gray-800">+91 77606 90784</span>
              </a>
            </motion.div>
          </div>
        </div>
