...
const DemoReel: React.FC = () => {
  ...
  return (
    <motion.div
      className="text-black p-8 flex items-center justify-center"
    ...
    >
      <div className="w-full max-w-[90vw]">
        <h1 className="text-4xl md:text-5xl font-heading font-bold mb-4 text-center">Demo Reel</h1>

        <p className="mb-6 text-lg text-gray-700 max-w-3xl mx-auto text-center">
        ...
        <div className="flex flex-col items-center">
          <div className="w-full" style={{ aspectRatio: '16/9', maxHeight: '85vh' }}>
            <iframe
              title="Demo Reel"
