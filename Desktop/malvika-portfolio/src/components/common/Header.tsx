...
const Header: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Taller header: title stays centered vertically, links sit lower */}
      <nav className="container mx-auto flex justify-between items-start py-4 px-6 font-heading" style={{ minHeight: 120 }}>
        <Link
          href="/"
        ...
        <div className="flex items-end space-x-6 self-end pb-3">
          <Link
            href="/demo-reel"
          ...
          {/* Animated header cat: hover wiggle, click twirl (respects prefers-reduced-motion) with subtle blue glow */}
          <motion.img
